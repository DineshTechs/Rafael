...
contract Owned {
    ...
    constructor(address _towner)  {
        require(_towner != address(0), "Owner address cannot be 0");
        owner = _towner;
        emit OwnerChanged(address(0), _towner);
    }
...
contract StakingRewards is Owned, Pausable {
     ...
     function stake(uint256 amount, uint256 stakeType) external {
        ...
        if(stakeType == 1){
            if(user[msg.sender].stakedBal1 > 0){
                rewardsBeforeNewStake1[msg.sender] = IntervalRewardsOf1(msg.sender);
            }
            user[msg.sender].stakedBal1 = user[msg.sender].stakedBal1 + amount;
            user[msg.sender].lockTime1 = getTime() + 30 days;        
        }
        else if(stakeType == 2){
            if(user[msg.sender].stakedBal2 > 0){
                rewardsBeforeNewStake2[msg.sender] = IntervalRewardsOf2(msg.sender);
            }
            user[msg.sender].stakedBal2 = user[msg.sender].stakedBal2 + amount;
            user[msg.sender].lockTime2 = getTime() + 90 days; 
        }
        else if(stakeType == 3){
            if(user[msg.sender].stakedBal3 > 0){
                rewardsBeforeNewStake3[msg.sender] = IntervalRewardsOf3(msg.sender);
            }
            user[msg.sender].stakedBal3 = user[msg.sender].stakedBal3 + amount;
            user[msg.sender].lockTime3 = getTime() + 365 days; 
        }       
        else if(stakeType == 4){
            if(user[msg.sender].stakedBal4 > 0){
                rewardsBeforeNewStake4[msg.sender] = IntervalRewardsOf4(msg.sender);
            }
            user[msg.sender].stakedBal4 = user[msg.sender].stakedBal4 + amount;
            user[msg.sender].lockTime4 = getTime() + 730 days; 
        }
    ...
    function unstake1() external{
        ...
        require(user[msg.sender].lockTime1 < block.timestamp,"Lock Period Not Finished!");
        withdrawReward1();

        uint256 amount = user[msg.sender].stakedBal1;
        stakingToken.safeTransfer(msg.sender, amount);

        emit Unstaked(msg.sender, user[msg.sender].stakedBal1);
        
        user[msg.sender].stakedBal1 = 0;
        user[msg.sender].stakeTime1 = 0;
    ...
    function unstake2() external{
        ...
        require(user[msg.sender].lockTime2 < block.timestamp,"Lock Period Not Finished!");
        withdrawReward2();

        uint256 amount = user[msg.sender].stakedBal2; 
        stakingToken.safeTransfer(msg.sender, amount);

        emit Unstaked(msg.sender, user[msg.sender].stakedBal2);
        
        user[msg.sender].stakedBal2 = 0;
        user[msg.sender].stakeTime2 = 0;
    ...
    function unstake3() external{
        ...
        require(user[msg.sender].lockTime3 < block.timestamp,"Lock Period Not Finished!");
        withdrawReward3();

        uint256 amount = user[msg.sender].stakedBal3;
        stakingToken.safeTransfer(msg.sender, amount);

        emit Unstaked(msg.sender, user[msg.sender].stakedBal3);
        
        user[msg.sender].stakedBal3 = 0;
        user[msg.sender].stakeTime3 = 0;
        user[msg.sender].lockTime3 = 0;
    }

    function unstake4() external{
        require(user[msg.sender].stakedBal4 > 0, "Account does not have a balance staked");
        require(user[msg.sender].lockTime4 < block.timestamp,"Lock Period Not Finished!");
        withdrawReward4();

        uint256 amount = user[msg.sender].stakedBal4;
        stakingToken.safeTransfer(msg.sender, amount);

        emit Unstaked(msg.sender, user[msg.sender].stakedBal4);
        
        user[msg.sender].stakedBal4 = 0;
        user[msg.sender].stakeTime4 = 0;
        user[msg.sender].lockTime4 = 0;
    }
    ...
    function withdrawReward1() public{
        ...
        uint256 intervals = timeDiff.div(rewardInterval);
        user[msg.sender].stakeTime1 = user[msg.sender].stakeTime1 + (intervals.mul(86400));
        ///////////////////////////////////////////        

        if(rewards > 0){
            tax = rewards.div(4); // 25% tax
            rewards = rewards - tax; 
        }else{
            rewards = 0;
        }
        ...
        stakingToken.safeTransfer(treasuryWallet, tax);
    ...
    function withdrawReward2() public{
        ...
        uint256 intervals = timeDiff.div(rewardInterval);
        user[msg.sender].stakeTime2 = user[msg.sender].stakeTime2 + (intervals.mul(86400));
        ///////////////////////////////////////////        
    ...
    function withdrawReward3() public{
        ...
        uint256 intervals = timeDiff.div(rewardInterval);
        user[msg.sender].stakeTime3 = user[msg.sender].stakeTime3 + (intervals.mul(86400));
        ///////////////////////////////////////////        
    ...
    function withdrawReward4() public{
        uint256 tax;
        ...
        uint256 intervals = timeDiff.div(rewardInterval);
        user[msg.sender].stakeTime4 = user[msg.sender].stakeTime4 + (intervals.mul(86400));
        ///////////////////////////////////////////        
